...
public final class AdvancedPluginTimer implements Serializable {
     ...
     */
    public AdvancedPluginTimer(final int time, final boolean restartTimer) {
        back = time;
        original = time;
     ...
     */
    public AdvancedPluginTimer(final int periodTime) {
        back = 1;
        original = 1;
        restart = true;
        lastId++;
