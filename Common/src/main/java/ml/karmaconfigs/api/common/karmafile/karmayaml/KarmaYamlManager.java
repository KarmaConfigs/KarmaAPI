...
public final class KarmaYamlManager {
     ...
     * @return the section karma configuration
     */
    @NotNull
    public final KarmaYamlManager getSection(final String path) throws RuntimeException {
        ...
        if (value instanceof Map) {
            ...
            throw new RuntimeException("The specified configuration path is not a configuration section path or does not exist");
        }
    }
