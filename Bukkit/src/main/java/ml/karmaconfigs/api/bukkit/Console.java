...
import ml.karmaconfigs.api.bukkit.util.PrefixConsoleData;
...
public interface Console {
    ...
    static void send(@NotNull final String message) {
        if (message.contains("\n")) {
            for (String msg : message.split("\n"))
                Bukkit.getServer().getConsoleSender().sendMessage(StringUtils.toColor(msg));
        } else {
    ...
    static void send(@NotNull final JavaPlugin sender, @NotNull String message, @NotNull final Level level) {
        ...
        if (message.contains("\n")) {
            for (String msg : message.split("\n"))
                Bukkit.getServer().getConsoleSender().sendMessage(StringUtils.toColor(prefix + msg));
        } else {
