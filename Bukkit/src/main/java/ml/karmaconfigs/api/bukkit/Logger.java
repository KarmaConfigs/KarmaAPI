...
public class Logger {
    ...
    private final static HashMap<JavaPlugin, Calendar> calendar_type = new HashMap<>();
    private final static HashMap<JavaPlugin, LogExtension> ext_type = new HashMap<>();
    private final static Map<JavaPlugin, Integer> max_size = new HashMap<>();
     ...
     * @param p the plugin
     */
    public Logger(@NotNull final JavaPlugin p) {
        Main = p;
    }
     ...
     */
    public final void setLogsExtension(final LogExtension extension) {
        ext_type.put(Main, extension);
    }
                            ...
                            if (logFile.exists()) {
                                ...
                                while ((line = reader.readLine()) != null) {
                                    if (line.startsWith("Plugin version:")) {
                                        ...
                                        if (line.startsWith("Server version: " + Main.getServer().getVersion() + "Plugin version:")) {
                                            line = "Server version: " + Main.getServer().getVersion() + "<br>\nPlugin version:" + Main.getDescription().getVersion() + "<br";
                                        }
                                    }
                                    lines.add(line + "\n");
                                }
                                ...
                                if (created) {
                                    ...
                                    writer.write("Server version: " + Main.getServer().getVersion() + "<br>\n");
                                    writer.write("Plugin version: " + Main.getDescription().getVersion() + "<br>\n");
                                    writer.write("Plugin authors: \n\n");
                                    for (String author : Main.getDescription().getAuthors()) {
                                        writer.write("      - " + author + "\n");
                                    }
                                    writer.write("Plugin description: " + Main.getDescription().getDescription() + "<br>\n");
                                    writer.write("Plugin website: " + (Main.getDescription().getWebsite() != null ? Main.getDescription().getWebsite() : "No website found") + "<br><br>\n\n");
                                }
     ...
     */
    public final void scheduleLog(@NotNull final Level level, @NotNull final String tmpInfo, final Object... replaces) {
        AsyncScheduler scheduler = new AsyncScheduler(Main);
